...
const addMovie = () => {
  ...
  newMovieDescription.textContent = document.querySelector(
    "#movie-description"
  ).value;
  ...
  switch (chosenGenre) {
    case "Action":
      selectedGenre = movieItem.filter(
        (movie) => movie.children[2].children[1].textContent !== "Action"
      );
      break;
    case "Comedy":
      selectedGenre = movieItem.filter(
        (movie) => movie.children[2].children[1].textContent !== "Comedy"
      );
      break;
    case "Drama":
      selectedGenre = movieItem.filter(
        (movie) => movie.children[2].children[1].textContent !== "Drama"
      );
      break;
    case "Horror":
      selectedGenre = movieItem.filter(
        (movie) => movie.children[2].children[1].textContent !== "Horror"
      );
      break;
    case "Romance":
      selectedGenre = movieItem.filter(
        (movie) => movie.children[2].children[1].textContent !== "Romance"
      );
      break;
    default:
      break;
